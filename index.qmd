...
Spectropath is a small R package built around the notation used in the paper.
It takes an ordered coordinate together with a measured line profile and
returns a compact set of low-order coordinates for asymmetry,
core-versus-wing structure, higher-order modulation, and
